...
import { BRAND_QUERY, DEAL_PRODUCTS_QUERY, LATEST_BLOGS_QUERY, PRODUCT_BY_BRAND_QUERY } from "./query";
...
export { getCategories, getAllBrands, getLatestBlogs, getProductsByBrand, getDealProduct }; 