...
const ProductGrid = () => {
  ...
  return (
    <div className="py-4 px-auto flex flex-col gap-2">
      ...
      {loading ? (
        <div className="flex flex-col items-center justify-center py-10 min-h-80 gap-4 bg-bglight w-full mt-10">
        ...
        <div className="grid p-4 rounded-md bg-bglight grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-2.5 mt-10">
