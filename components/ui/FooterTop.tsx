...
const FooterTop = () => {
  return (
        ...
        <div className="grid grid-cols-1 border-y-2 border-gray-300 text-black md:grid-cols-2 lg:grid-cols-4 gap-4 ">
            {
                data.map((item)=>(
                    <div key={item?.id} className="flex items-center  space-x-4 cursor-pointer  hover:bg-banner  group hoverEffect p-2">
