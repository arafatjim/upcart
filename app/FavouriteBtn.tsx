  ...
  return (
    <div>
      ...
      <Link href="/cart" className="group relative group hoverEffect ">
        ...
        <span className='absolute -top-1.5 -right-7  text-white w-4 h-4 p-2 rounded-full flex items-center justify-center text-sm font-bold group-hover:scale-110 transition-transform duration-300 ease-in-out '>0</span>
      </Link>
    </div>
  )
}
